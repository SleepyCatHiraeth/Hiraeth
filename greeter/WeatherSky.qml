// Copy of modules/widgets/dashboard/widgets/WeatherWidget.qml for the greeter,
// which cannot import the shell's modules. WeatherService is replaced by the
// Weather singleton; the debug toggle is dropped. Keep in step with the original.
//
// Derived from Ambxst by Axenide (https://github.com/Axenide/Ambxst),
// AGPL-3.0-or-later. Modified 2026-09 by Hiraeth for the greeter.
...
ClippingRectangle {
    ...
    onVisibleChanged: {
        if (visible && !Weather.dataAvailable && !Weather.isLoading) {
    ...
    readonly property var blend: Weather.effectiveTimeBlend
    ...
    readonly property string weatherEffect: Weather.effectiveWeatherEffect
    readonly property real weatherIntensity: Weather.effectiveWeatherIntensity
    ...
    Item {
        ...
        Canvas {
            ...
            property color arcColor: Weather.effectiveIsDay ? Qt.rgba(1, 1, 1, 0.7) : Qt.rgba(1, 1, 1, 0.4)
        ...
        Rectangle {
            ...
            property real progress: Weather.effectiveSunProgress
            ...
            gradient: Gradient {
                GradientStop {
                    position: 0.0
                    color: Weather.effectiveIsDay ? "#FFF9C4" : "#FFFFFF"
                }
                GradientStop {
                    position: 0.5
                    color: Weather.effectiveIsDay ? "#FFE082" : "#E8E8E8"
                }
                GradientStop {
                    position: 1.0
                    color: Weather.effectiveIsDay ? "#FFB74D" : "#C0C0C0"
                }
            }
            ...
            Rectangle {
                ...
                radius: width / 2
                color: "transparent"
                border.color: Weather.effectiveIsDay ? Qt.rgba(1, 0.95, 0.7, 0.4) : Qt.rgba(1, 1, 1, 0.2)
                border.width: 3
                z: -1
            }
            ...
            Rectangle {
                ...
                radius: width / 2
                color: "transparent"
                border.color: Weather.effectiveIsDay ? Qt.rgba(1, 0.95, 0.7, 0.6) : Qt.rgba(1, 1, 1, 0.3)
                border.width: 2
                z: -1
            }
        }
    ...
    Item {
        ...
        Text {
            id: tempText
            visible: Weather.dataAvailable
            text: Math.round(Weather.currentTemp) + "°" + Weather.unit
            color: "#FFFFFF"
    ...
    Item {
        ...
        Text {
            id: descText
            text: Weather.dataAvailable ? Weather.effectiveWeatherDescription : "Error"
